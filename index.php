			...
			<div class="col-8 px-0 my-2"> 
				...
				<div class="mt-5 border rounded">   
					<div class="col-12 px-1">
						<div class="row">
							...
							<input value='<?php echo $result["id"] ?>' class="form-control" name="id" style='display:none'>
								<button class="btn" style="margin-left: 20px"><i class="fa fa-trash"></i></button>	
							</form>	
					...
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<div>
							<form class="forma" style="display: none" action="insta.php" method="GET">
								<input value='<?php echo $result["id"] ?>' class="form-control" type="" name="id">
								<input value='<?php echo $result["img"] ?>' class="form-control" type="" name="img">
								<input value='<?php echo $result["text"] ?>' class="form-control" type="" name="text">
